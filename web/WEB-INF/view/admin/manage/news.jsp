            ...
            <div class="d-flex flex-column pt-3 pb-5 mb-3">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <%--如果当前页面为第一页时，上一页按钮禁用--%>
                        <c:choose>
                            <c:when test="${requestScope.newsVoPage.pageIndex eq 1}">
                        ...
                        <c:choose>
                            <c:when test="${requestScope.newsVoPage.pageIndex >= requestScope.newsVoPage.totalPage}">
                            ...
                            <c:otherwise>
                                <li class="page-item">
                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/manage/news?pageIndex=${requestScope.newsPage.pageIndex+1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                        <span class="sr-only">Next</span>
                                    </a>
                                </li>
